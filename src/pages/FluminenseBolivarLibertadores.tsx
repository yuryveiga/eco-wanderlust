...
const FluminenseBolivarLibertadores = () => {
  const targetDate = new Date('2026-05-19T21:30:00-03:00');
  const [countdown, setCountdown] = useState({ days: '00', hours: '00', mins: '00', secs: '00', isLive: false });
    ...
    <div className="landing-page-container">
      ...
      <section className="hero">
        ...
        {countdown.isLive ? (
          ...
          <div className="countdown">
            <div className="cd-block"><div className="cd-num">{countdown.days}</div><div className="cd-label">Days</div></div>
            <div className="cd-sep">:</div>
            <div className="cd-block"><div className="cd-num">{countdown.hours}</div><div className="cd-label">Hours</div></div>
            <div className="cd-sep">:</div>
            <div className="cd-block"><div className="cd-num">{countdown.mins}</div><div className="cd-label">Mins</div></div>
            <div className="cd-sep">:</div>
            <div className="cd-block"><div className="cd-num">{countdown.secs}</div><div className="cd-label">Secs</div></div>
          </div>
        )}
