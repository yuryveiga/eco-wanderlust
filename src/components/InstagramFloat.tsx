...
export function InstagramFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-50 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 group"
