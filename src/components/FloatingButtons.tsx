    ...
    <div className="fixed right-4 bottom-4 md:right-6 md:bottom-6 z-50 flex flex-col gap-2 md:gap-3 items-end pointer-events-auto">
      ...
      {instagram && (
        <a
          ...
          className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white shadow-2xl hover:scale-110 active:scale-95 transition-all flex items-center justify-center"
          aria-label="Instagram"
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 md:w-7 md:h-7" fill="currentColor">
      ...
      {youtube && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-[#FF0000] text-white shadow-2xl hover:scale-110 active:scale-95 transition-all flex items-center justify-center transition-opacity duration-300"
          aria-label="YouTube"
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 md:w-7 md:h-7" fill="currentColor">
      ...
      {whatsapp && (
        <button
          ...
          className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-[#25D366] text-white shadow-2xl hover:scale-110 active:scale-95 transition-all flex items-center justify-center"
          aria-label="WhatsApp"
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 md:w-7 md:h-7" fill="currentColor">
