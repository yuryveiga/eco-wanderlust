...
export function TripAdvisorFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-40 right-6 z-50 bg-[#00AA6C] text-white p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 group"
