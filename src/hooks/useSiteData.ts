...
const fallbackTours: LovableTour[] = [
  { id: "1", title: "City Tour Rio Completo", short_description: "Conheça os pontos turísticos mais icônicos do Rio de Janeiro.", price: 250, duration: "8 horas", max_group_size: 15, image_url: "/maracana-hero.jpg", is_featured: true, category: "City Tour", is_active: true, sort_order: 1 },
  ...
  { id: "3", title: "Angra dos Reis", short_description: "Navegue pelas ilhas paradisíacas de Angra dos Reis.", price: 200, duration: "10 horas", max_group_size: 25, image_url: "/maracana-hero.jpg", is_featured: true, category: "Barco", is_active: true, sort_order: 3 },
];
